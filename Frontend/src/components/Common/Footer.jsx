    ...
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div>
          ...
          <p className="text-gray-500 mb-4">
            Be the first to hear about new peoducts, exclusive events, and
            online offers.
          </p>
      ...
      <div>
        ...
        <div className="flex items-center space-x-4 mb-6">
          <a href="https:www.facbook.com" target="_blank" rel="noopener noreferrer" className='hover:text-gray-300 hover:bg-gray-800'><TbBrandMeta className="h-6 w-6"/></a>
          <a href="https:www.facbook.com" target="_blank" rel="noopener noreferrer" className='hover:text-gray-300 hover:bg-gray-800'><IoLogoInstagram className="h-6 w-6"/></a>
          <a href="https:www.facbook.com" target="_blank" rel="noopener noreferrer" className='hover:text-gray-300 hover:bg-gray-800'><RiTwitterXLine className="h-6 w-6"/></a>
        </div>
